...
function PatientRegistration(){
 ...
 const loginUrl=`/?email=${encodeURIComponent(form.email)}&next=${encodeURIComponent(`/registro/paciente?token=${token||''}`)}`;
